  ...
  <section id="new-phones">
    <div class="container">
        ...
        <div class="item py-2 bg-light">
            <div class="product">
                <a href="product.php?item_id=<?php echo $item['item_id'];?>"><img src="./admin/<?php echo $item['item_image'] ?? "./assets/products/1jfif.jfif";?>" alt="product1" class="img-fluid"></a>
